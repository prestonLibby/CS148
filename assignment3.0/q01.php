<?php
	...
	print '<table>';
	$columns = 1;
    $query = 'SELECT DISTINCT fldCourseName FROM tblCourses INNER JOIN tblEnrolls ON tblCourses.pmkCourseId = tblEnrolls.fnkCourseId WHERE fldGrade >= 100 ORDER BY fldCourseName ASC';
